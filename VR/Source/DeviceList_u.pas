...
uses
  ...
  Dialogs, MaximizedUnit, Menus, //TxFrame,
  DbGridUnit, ExtCtrls, DB, MemDS,
  VirtualTable, StdCtrls, ShellAPI,DBGridEh,  DBCtrlsEh, Grids, TxFrame;
...
type
  TDeviceListForm = class(TMaximizedForm)
    ...
    N4: TMenuItem;
    fltfldVTAdditive_shift: TFloatField;
